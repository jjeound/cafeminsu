...
import com.cafeminsu.core.network.model.request.auth.LocationRequest
import com.cafeminsu.core.network.model.request.auth.NicknameUpdateRequest
import com.cafeminsu.core.network.model.request.auth.OwnerLoginRequest
import com.cafeminsu.core.network.model.request.auth.SignupRequest
import com.cafeminsu.core.network.model.request.auth.FcmTokenRequest
...
import com.cafeminsu.core.network.model.response.auth.LocationResponse
import com.cafeminsu.core.network.model.response.auth.NicknameUpdateResponse
import com.cafeminsu.core.network.model.response.auth.OwnerLoginResponse
import com.cafeminsu.core.network.model.response.auth.PublicUserProfileResponse
import com.cafeminsu.core.network.model.response.auth.UserRoleResponse
